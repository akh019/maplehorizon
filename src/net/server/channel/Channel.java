...
public final class Channel {
    ...
    private static Map<String, Channel> pendingInstances = new HashMap<String, Channel>();
    ...
    //presidential shit c: *Troxied wuz here* ;D
    private String president = "";
    private int presidentialTakeOver = 0;
    // Olympics
    public static boolean olympicsState = false;
    ...
    public int getPresidentialTakeOver() {
        return presidentialTakeOver;
    }
    
    public void setPresidentialTakeOver(int amount) {
        this.presidentialTakeOver = amount;
    }
