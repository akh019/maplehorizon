                ...
                if (partner == null) {
                  ...
                  /*  if (partner.getGender() == chr.getGender()) {
                    ...
                    if(ring.toItem() instanceof Equip) {
                     ...
                     //   MapleInventoryManipulator.addById(chr.getClient(), ringid, (short)1);
                    //    MapleInventoryManipulator.addById(partner.getClient(), ringid, (short)1);
                        cs.gainCash(toCharge, -ring.getPrice());
                        chr.addCrushRing(MapleRing.loadFromDb(ringid));
                    /*    try {
                            chr.sendNote(partner.getName(), text, (byte) 0);
                        } catch (SQLException ex) {
                        } */
                      //  partner.showNote();
                    }   
           ...
           /* } else {
            ...
            if (chr.getMeso() > 0) {
                if (itemId == 4031180 || itemId == 4031192 || itemId == 4031191) {
                    ...
                    MapleInventoryManipulator.addById(c, itemId, (short) 0);
