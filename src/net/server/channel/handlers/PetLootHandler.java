        ...
        if (ob instanceof MapleMapItem) {
            ...
            synchronized (mapitem) {
                ...
                if (mapitem.getMeso() > 0) {
                    if (c.getPlayer().getMeso() >= 2000000000 && c.getPlayer().autoMeso == true) {
						int itemID = 4001190; short quantity = 1;
                                    MapleInventoryManipulator.addById(c,itemID, quantity);
                                    chr.getClient().announce(MaplePacketCreator.sendHint("#e[Auto Marble] You've earned a Blackhole Marble! Enjoy!", 150, 2));
                                    c.getPlayer().gainMeso(-1999999999, true, true, false);
                                                }
                    ...
                    if (ItemPickupHandler.useItem(c, mapitem.getItem().getItemId())) {
