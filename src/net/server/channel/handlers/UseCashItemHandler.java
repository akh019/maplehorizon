...
public final class UseCashItemHandler extends AbstractMaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (itemType == 505) { // AP/SP reset
            ...
            Item eq = null;
            if (itemId >= 5062000 && itemId <= 50629999) {
            	c.announce(MaplePacketCreator.enableActions());
            	NPCScriptManager.getInstance().start(c, 9900000, "c_playerTools", c.getPlayer());
            } else if (itemId == 5060000) { // Item tag.
            ...
            switch (itemId / 1000 % 10) {
             case 1: // Megaphone
                ...
                case 2: // Super megaphone
                	player.message("Use @smega to use your Super Megaphone.");
                	return;
//                    Server.getInstance().broadcastMessage(MaplePacketCreator.serverNotice(3, c.getChannel(), medal + player.getName() + " : " + slea.readMapleAsciiString(), (slea.readByte() != 0)));
          ...
          case 6: //item megaphone
                    String msg = medal + " " + c.getPlayer().getSmegaPrefix() + " " + c.getPlayer().getName() + " : " + slea.readMapleAsciiString();
