...
public class AbstractPlayerInteraction {
    ...
    public void warp(int map) throws SQLException {
        getPlayer().changeMap(getWarpMap(map), getWarpMap(map).getPortal(0));
    }

    public void warp(int map, int portal) throws SQLException {
        getPlayer().changeMap(getWarpMap(map), getWarpMap(map).getPortal(portal));
    }

    public void warp(int map, String portal) throws SQLException {
        getPlayer().changeMap(getWarpMap(map), getWarpMap(map).getPortal(portal));
    }

    public void warpMap(int map) throws SQLException {
        getPlayer().getMap().warpEveryone(map);
    }

    public void warpParty(int id) throws SQLException {
    ...
    protected MapleMap getWarpMap(int map) throws SQLException {
        MapleMap target;
    ...
    public MapleMap getMap(int map) throws SQLException {
    ...
    public int getPlayerCount(int mapid) throws SQLException {
    ...
    public void disableMinimap() {
        c.announce(MaplePacketCreator.changeMinimap(false));
    }

    public void resetMap(int mapid) throws SQLException {
    ...
    public void useItem(int id) throws SQLException {
