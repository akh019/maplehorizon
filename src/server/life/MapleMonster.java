...
public class MapleMonster extends AbstractLoadedMapleLife {
    ...
    private List<DropEntry> customDrops = new ArrayList<>();
    ...
    public MapleMonsterStats getDefaultStats() {
    	return stats;
    }
    
    public void setOverrideStat(MapleMonsterStats override) {
    	overridestats = override;
    }
