...
public class MapleGenericPortal implements MaplePortal {
    ...
    public void enterPortal(MapleClient c) {
        ...
        if (getScriptName() != null) {
            ...
            MapleMap to = null;
            try {
                to = c.getPlayer().getEventInstance() == null ? c.getChannelServer().getMapFactory().getMap(getTargetMapId()) : c.getPlayer().getEventInstance().getMapInstance(getTargetMapId());
