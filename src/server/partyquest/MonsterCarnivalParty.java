...
public class MonsterCarnivalParty {
    ...
    public void warpOut(final int map) throws SQLException {
    ...
    public void warp(final MapleMap map, final int portalid) throws SQLException {
        for (MapleCharacter chr : members) {
            chr.changeMap(map, map.getPortal(portalid));
        }
    }

    public void warpOut() throws SQLException {
        if (winner == true)
    ...
    public void removeMember(MapleCharacter chr) throws SQLException {
        members.remove(chr);
